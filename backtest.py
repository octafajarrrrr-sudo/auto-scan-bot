...
def run_backtest(engine, symbol: str, tf_bias: str = "4h",
    ...
    """
    df_bias  = engine.fetch_ohlcv(symbol, tf_bias,  lookback)
    df_entry = engine.fetch_ohlcv(symbol, tf_entry, lookback * 4)
